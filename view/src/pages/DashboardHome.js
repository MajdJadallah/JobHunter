...
return (<>
  <nav className="navbar navbar-light bg-light">
    <div className="container-fluid" style={{padding:"1rem 3rem 0"}}>
      <h1 className="h3 mb-3"><strong>JobHunter</strong> Dashboard</h1>
  ...
  <main id="dashBoardMain">
            ...
            <div className="card-body" >
              <div className="row">
               <div className="col mt-0">
                <h5 className="card-title" style={{fontFamily:"'Roboto Slab', serif"}}>Review</h5>
               </div>
    ...
    <div className="col-sm-3">
      ...
      <div className="card-body" >
        <div className="row">
          <div className="col mt-0">
            <h5 className="card-title" style={{fontFamily:"'Roboto Slab', serif"}}>Visitors</h5>
          </div>
          <div className="col-auto">
            <div className="stat text-primary">
              <i
    ...
    <div className="col-sm-3">
      <div className="card">
        <div className="card-body">
          <div className="row">
            <div className="col mt-0">
              <h5 className="card-title" style={{fontFamily:"'Roboto Slab', serif"}}>schedule</h5>
            </div>
            <div className="col-auto">
              <div className="stat text-primary">
                <i
    ...
    <div className="card-body">
      <div className="row">
        <div className="col mt-0">
          <h5 className="card-title" style={{fontFamily:"'Roboto Slab', serif"}}>Message</h5>
        </div>
        <div className="col-auto">
          <div className="stat text-primary">
            <i
      ...
      <div className="row">
        <div className="col-12 col-lg-8 col-xxl-9 d-flex">
          <div className="card flex-fill">
            <div className="card-header"style={{backgroundColor:"#198754",color:"#fff"}} >
              <h5 className="card-title mb-0" style={{fontFamily:"'Roboto Slab', serif"}}>Latest Users</h5>
            </div>
            <table className="table table-hover my-0 px-5" style={{padding:".5rem 2rem"}}>
        ...
        <div className="col-12 col-md-6 col-xxl-3 d-flex order-1 order-xxl-1">
          <div className="card flex-fill">
            <div className="card-header" style={{backgroundColor:"#FFFFA9" ,color:"#000"}}>
              <h5 className="card-title mb-0" style={{fontFamily:"'Roboto Slab', serif"}} >Calendar</h5>
            </div>
